<footer>
		...
		<div class="footer-box">
			...
			<div class="footer-soc">
				...
				<div class="soc-item"><iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Freference%2Fplugins%2Flike&amp;width=120&amp;height=21&amp;colorscheme=light&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;send=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:120px; height:21px;" allowTransparency="true"></iframe></div>
	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				...
				<strong class="title-ite"><?=$item->brand->name; ?> <?=$item->name; ?></strong>
				<a href="/remembered/remember/<?=$catalog_id; ?>/<?=$item->id ?>" class="remo">Запомнить</a>
			</div>
			<div class="gal-info">
				<div class="gal-price">
					<strong class="title">Цена</strong>
					<strong class="price"><?=$this->kurs->create_price($item,'catalog'); ?> <strong class="rub">руб. за шт.</strong></strong>
				</div>
				<ul class="tov-feat-list" id="itmcard">
											<li>Производительность <?=$item->capacity->name; ?></li>
                                            <li>Расход мощности <?=$item->power_consumption->name; ?></li>
											<li>Объём помещения <?=$item->room_volume->name; ?></li>
                                            <li>Уровень шума <?=$item->noise->name; ?></li>
											<li>Кол-во режимов <?=$item->plintus_type->name; ?></li>
				</ul>
				<form action="/basket/insert_basket" class="spi-form" method="POST">
					<div class="row">
						...
						<div class="upaka">
							...
							<strong class="valua">&mdash;</strong>
						</div>
						<div class="kolva">
					...
					<div class="row">
						<a href="<?=$link_id.'/'.$item->brand->alias.'-'.$item->id.'-id'; ?>" class="green-button-40">Посмотреть</a>
			...
			<div class="sk-big-galery">
                ...
                <? foreach($data as $d) : ?>                                
					<li>
						<img src="/<?=$d->img; ?>" onclick="build_info(<?=$d->id; ?>,<?=$catalog_id; ?>);" />
