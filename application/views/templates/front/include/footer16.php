...
<div class="popup-type slideshow-popup" id="gal-popup" style="left: 50%; margin-left: -463.5px; z-index: 1002; position: absolute; top: 200px; margin-top: 0px; display: block;">
	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				<strong class="title-ite"><?=$item->matherial->name; ?> <?=$item->name; ?></strong>
			...
			<div class="gal-info">
				...
				<ul class="tov-feat-list" id="itmcard">
											<li>Длина <?=$item->length->name; ?></li>
                                            <li>Ширина <?=$item->width->name; ?></li>
											<li>Высота <?=$item->height->name; ?></li>
				...
				<form action="/basket/insert_basket" class="spi-form" method="POST">
					<div class="row">
						<div class="kod-tov">
							...
							<strong class="valua"><?=$catalog_id.'-'.$item->id ?></strong>
						</div>
						<div class="upaka">
					...
					<div class="row">
						<a href="<?=$link_id.'/'.$item->matherial->alias.'-'.$item->id.'-id'; ?>" class="green-button-40">Посмотреть</a>
