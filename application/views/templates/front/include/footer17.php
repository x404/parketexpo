...
<div class="popup-type slideshow-popup" id="gal-popup" style="left: 50%; margin-left: -463.5px; z-index: 1002; position: absolute; top: 200px; margin-top: 0px; display: block;">
	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				<strong class="title-ite"><?=$item->wood->name; ?> <?=$item->name; ?></strong>
			...
			<div class="gal-info">
				...
				<ul class="tov-feat-list" id="itmcard">
											<li>Диаметр <?=$item->diametr->name; ?></li>
                                            <li>Порода дерева <?=$item->wood->name; ?></li>
				</ul>
				<form action="/basket/insert_basket" class="spi-form" method="POST">
					...
					<div class="row">
						<a href="<?=$link_id.'/'.$item->wood->alias.'-'.$item->id.'-id'; ?>" class="green-button-40">Посмотреть</a>
