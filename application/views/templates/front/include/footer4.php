	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				...
				<strong class="title-ite">Ламинат <?=$item->brand->name; ?> <?=$item->brand->brand_ru; ?> <?=$item->name; ?></strong>
			...
			<div class="gal-info">
				...
				<ul class="tov-feat-list" id="itmcard">
					<li>Класс нагрузки <?=$item->load_class->name; ?></li>
					<li>Толщина <?=$item->thickness->name; ?></li>
					<li>Стиль <?=$item->polos->name; ?></li>
					<li>Размер <?=$item->size; ?> мм<a name="slideshow"></a></li>
