	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				...
				<strong class="title-ite"><?=$item->model_name->name; ?> <?=$item->name; ?> <?=$item->otbor->name; ?> <?=$item->surf->name; ?></strong>
			...
			<div class="gal-info">
				...
				<ul class="tov-feat-list" id="itmcard">
											<li>Название модели <?=$item->model_name->name; ?></li>
											<li>Толщина щита <?=$item->thickness->name; ?></li>
											<li>Диаметр <?=$item->diametr->name; ?></li>
											<li>Размер <?=$item->size; ?> мм</li>
											<li>Отбор древесины <?=$item->otbor->name; ?></li>
				</ul>
