	...
	<div class="pop-holder">
		<div class="pop-slida">
			<div class="title-pop">
				...
				<strong class="title-ite"><?=$item->lacquer_name->name; ?> <?=$item->name; ?> <?=$item->gloss->name; ?></strong>
			...
			<div class="gal-info">
				...
				<ul class="tov-feat-list" id="itmcard">
											<li>Основа <?=$item->base->name; ?></li>
                                            <li>Тип <?=$item->plintus_type->name; ?></li>
											<li>Время высыхания <?=$item->dry->name; ?></li>
                                            <li>Степень блеска <?=$item->gloss->name; ?></li>
				</ul>
				<form action="/basket/insert_basket" class="spi-form" method="POST">
					<div class="row">
						...
						<div class="upaka">
							...
							<strong class="valua"><?=$item->pack->name; ?></strong>
						</div>
						<div class="kolva">
